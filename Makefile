...
MACHDEP		:= -DBIGENDIAN -DHAVE_WCSDUP -DHAVE_WCS_POINTERS
...
install: $(BUILD)
	@echo Copying...
	@[ -d $(PORTLIBS)/include ] || mkdir -p $(PORTLIBS)/include
	@cp -frv src/mini18n.h $(PORTLIBS)/include
	@cp -frv src/mini18n-multi.h $(PORTLIBS)/include
